        ...
        <div className="conversation-area flex-grow flex flex-col ">
          <div className="message-box p-1 flex-grow flex flex-col gap-1">
            <div className="message max-w-56 flex flex-col p-2 bg-slate-50 w-fit rounded-md">
              <small className='opacity-65 text-xs'>example@hmail.com</small>
              <p className='text-sm'>Lorem ipsum dolor sit amet. Lorem ipsum doloasasasasasar sit amet.</p>
            </div>
          ...
          <div className="input-field w-full flex">
            <input className='p-2 px-4 border-none outline-none flex-grow' type="text" placeholder='Enter a message...' />
